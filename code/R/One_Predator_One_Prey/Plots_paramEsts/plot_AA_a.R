...
pdf('../../../../results/R/OnePredOnePrey_AA_a.pdf',height=6,width=5)
...
pdf('../../../../results/R/OnePredOnePrey_AA_a_xy.pdf',height=3,width=4)
...
pdf('../../../../results/R/OnePredOnePrey_AA_a_hist.pdf',height=2.5,width=4)
