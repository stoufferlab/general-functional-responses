...
pdf('../../../../results/R/OnePredOnePrey_figs/OnePredOnePrey_BD_a.pdf',height=6,width=5)
...
pdf('../../../../results/R/OnePredOnePrey_figs/OnePredOnePrey_BD_a_xy.pdf',height=3,width=4)
