...
accgoal=3;
maxRec=500;
P\[CapitalNu]prods=Sort[DeleteDuplicates[Join@@Outer[Times,Pvals,\[CapitalNu]vals]]];
P\[CapitalNu]rats=Sort[DeleteDuplicates[Join@@Outer[Divide,Pvals,\[CapitalNu]vals]]];
e=10;
ParmRangeA={
DeleteDuplicates[Flatten[{{a},Sort[{0,P\[CapitalNu]rats,Max[\[CapitalNu]vals]/P\[CapitalNu]prods,1,10^e},Less]}]],
DeleteDuplicates[Flatten[{{h},Sort[{0,P\[CapitalNu]rats,Max[\[CapitalNu]vals]/P\[CapitalNu]prods,1,10^e},Less]}]],
DeleteDuplicates[Flatten[{{\[Gamma]},Sort[{0,1/Pvals,Max[\[CapitalNu]vals]/P\[CapitalNu]prods,1,10^e},Less]}]],
DeleteDuplicates[Flatten[{{m},Sort[{0,P\[CapitalNu]rats,Max[\[CapitalNu]vals]/P\[CapitalNu]prods,1,10^e},Less]}]]
};
